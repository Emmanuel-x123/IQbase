...
const CourseDetails = () => {
  ...
  const {allCourses, calculateCourseChapterTime, calculateCourseDuration, calculateNoOfLectures, currency} = useContext(AppContext)
  ...
  return courseData ? (
    ...
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
     ...
     <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
       ...
       <p className='text-sm'>Course by <span className='text-blue-600 underline'>Emmanuel Reuben</span></p>
            ...
            <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
              <div className='flex items-center justify-between px-4 py-3 cursor-pointer select-none'onClick={()=> toggleSection(index)}>
                <div className='flex items-center gap-2'>
                  <img className={`transform transition-trnasform ${openSections[index] ? 'rotate-180' : '' }`}
      ...
      md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
        ...
        {
         playData ?
          <Youtube videoId={playData.videoId} opts={{playerVars : {
          ...
          <button className='md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium'>
            ...
            <div className='pt-6'>
              ...
              <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
                ...
                <li>Step-by-step hands-on project with guidiance.</li>
