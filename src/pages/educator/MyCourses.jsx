    ...
    <div className="p-6 lg:ml-10 pt-20 w-full max-w-7xl">
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <h1 className="text-2xl font-bold text-gray-800 mb-4 md:mb-0">My Courses</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full md:w-auto">
            ...
            <div className="bg-purple-50 p-4 rounded-lg">
              <div className="flex items-center">
                <img src={assets.earning_icon} alt="Earnings" className="w-6 h-6 mr-2" />
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
          <div className="flex space-x-2">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-md ${filter === 'published' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700'}`}
            >
              Published
            </button>
            <button
              onClick={() => setFilter('draft')}
              className={`px-4 py-2 rounded-md ${filter === 'draft' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700'}`}
            >
              Drafts
            </button>
          </div>
